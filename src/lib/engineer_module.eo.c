...
void * _engineer_module_data_get(Eo *obj, Engineer_Module_Data *pd, unsigned int cacheid);

EOAPI EFL_FUNC_BODYV_CONST(engineer_module_data_get, void *, 0, EFL_FUNC_CALL(cacheid), unsigned int cacheid);
...
EOAPI EFL_VOID_FUNC_BODYV_CONST(engineer_module_component_start, EFL_FUNC_CALL(dt), unsigned long dt);
EOAPI EFL_VOID_FUNC_BODYV_CONST(engineer_module_component_update, EFL_FUNC_CALL(dt), unsigned long dt);
