...
EOAPI void engineer_scene_respond(Eo *obj, Eina_Inarray *inboxs);

EOAPI Eina_Bool engineer_scene_entity_create(Eo *obj, uint64_t id, uint64_t parent, const char *name);

EOAPI uint64_t engineer_scene_entity_lookup(Eo *obj, uint64_t target);

EOAPI void engineer_scene_entity_parent_set(Eo *obj, uint64_t target, uint64_t parent);

EOAPI void engineer_scene_entity_siblingnext_set(Eo *obj, uint64_t target, uint64_t component);

EOAPI uint64_t engineer_scene_entity_siblingnext_get(Eo *obj, uint64_t target);

EOAPI void engineer_scene_entity_siblingprev_set(Eo *obj, uint64_t target, uint64_t component);

EOAPI uint64_t engineer_scene_entity_siblingprev_get(Eo *obj, uint64_t target);

EOAPI void engineer_scene_entity_firstentity_set(Eo *obj, uint64_t target, uint64_t component);

EOAPI uint64_t engineer_scene_entity_firstentity_get(Eo *obj, uint64_t target);
...
EOAPI void engineer_scene_notice_push_event(Eo *obj, uint64_t sender, uint64_t type, uint64_t entityid, void *payload, uint64_t size);
