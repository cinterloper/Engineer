...
EOAPI uint64_t engineer_node_entity_location_get(Eo *obj, uint64_t target);

EOAPI void engineer_node_entity_location_set(Eo *obj, uint64_t target, uint64_t location);
...
EOAPI uint64_t engineer_node_component_location_get(Eo *obj, uint64_t target);

EOAPI void engineer_node_component_location_set(Eo *obj, uint64_t target, uint64_t location);
